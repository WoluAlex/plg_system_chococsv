...
// If enabled, this will create a output.json file
        ...
        $givenDestinations = [
            [
                'ref' => [
                    'tokenindex' => self::$apiConfig['chococsv001']['TOKEN_INDEX'],
                    'base_url' => self::$apiConfig['chococsv001']['BASE_URL'],
                    'base_path' => self::$apiConfig['chococsv001']['BASE_PATH'],
                    'show_form' => 1,
                    'is_active' => 1,
            ...
            [
                'ref' => [
                    'tokenindex' => self::$apiConfig['chococsv002']['TOKEN_INDEX'],
                    'base_url' => self::$apiConfig['chococsv002']['BASE_URL'],
                    'base_path' => self::$apiConfig['chococsv002']['BASE_PATH'],
                    'show_form' => 1,
                    'is_active' => 1,
    ...
    public function testCSVReaderWithJ44xDestination()
    {
        ...
        /**
         * @var Destination $j44xDestination
         */
        $j44xDestination = $typedDestinations[0];

        //When
        $this->deployArticleCommand->testCsvReader($this->deployArticleCommandState, $j44xDestination);
    }
    ...
    public function testCSVReaderWithJ51xDestination()
    {
        ...
        /**
         * @var Destination $j51xDestination
         */
        $j51xDestination = $typedDestinations[1];

        //When
        $this->deployArticleCommand->testCsvReader($this->deployArticleCommandState, $j51xDestination);
    }
